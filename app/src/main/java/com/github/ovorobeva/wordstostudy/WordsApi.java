...
public interface WordsApi {
    ...
    @GET("word.json/")
    Call<JSONArray> getPartOfSpeech(@Query("includeRelated") boolean includeRelated,
    ...
    @GET("words.json/")
    Call<JSONArray> getRandomWords(@Query("isHasDictionaryDef") boolean isHasDictionaryDef,
